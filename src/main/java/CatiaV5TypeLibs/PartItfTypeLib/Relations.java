...
public interface Relations extends Collection {
   ...
   * @param iOutputParameter Mandatory CatiaV5TypeLibs.PartItfTypeLib.Parameter parameter.
   * @param iFormulaBody Mandatory Holder<java.lang.String> parameter.
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.Formula
   */
   ...
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.Rule
   */
   ...
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.Check
   */
   ...
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.DesignTable
   */
   ...
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.Law
   */
   ...
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.Relation
   */
  ...
  /**
   * <p>
   * Getter method for the COM property "CatiaV5TypeLibs.PartItfTypeLib.Optimizations"
   * </p>
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.Optimizations
   */
  ...
  /**
   * <p>
   * Getter method for the COM property "CatiaV5TypeLibs.PartItfTypeLib.FeatureGenerator"
   * </p>
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.FeatureGenerator
   */
