...
public interface Parameters extends Collection {
   ...
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.BoolParam
   */
  ...
  /**
   * @param iName Mandatory Holder<java.lang.String> parameter.
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.ListParameter
   */
  ...
  /**
   * <p>
   * Getter method for the COM property "CatiaV5TypeLibs.PartItfTypeLib.Units"
   * </p>
   * @return  Returns a value of type CatiaV5TypeLibs.PartItfTypeLib.Units
   */
